...
//#include "tally_and_output.hpp"
//#include "bits_utils.hpp"

using namespace std;

const unsigned long long Primes[200] =
{
  ...
  1153, 1163, 1171, 1181, 1187, 1193, 1201, 1213, 1217, 1223, 1229 // 199
};
...
unsigned long long Nucleotides[4] = 
{
//  3, 5, 7, 11
//  1, 2, 3, 4
//  2, 4, 6, 8
...
void generate_lookup_table()
{
  ...
  for ( int i = 0; i < PRIME_GROUPS; ++i )
  {
    ...
    for ( int j = 0; j < CHUNK_PERMUTATIONS; ++j )
    {
      ...
      {      
        //cout << CurrentPrimes[l] << "^" << Nucleotides[ lNucleotide & 3 ] << " * ";
